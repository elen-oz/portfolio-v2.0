            ...
            <li className='w-full flex gap-x-2 hover:bg-gray'>
              <div className='flex-1'>
                ...
                <p className=''>
                  ...
                  beatae, nobis repellat quisquam aliquid incidunt excepturi
                  saepe cumque neque corrupti laudantium officiis, iure
                  distinctio perspiciatis temporibus! Nisi illo architecto sit!
                </p>
